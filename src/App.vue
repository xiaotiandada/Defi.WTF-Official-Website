      ...
      <div class="container  ">
        <div class="row">
          <div class=" about wow fadeInUp col-md-6 col-xs-6 col-sm-12" data-wow-delay="0.2s">
            <h2>About WTF: the Power of Asking</h2>
            <p>
              A modern resurrection of the Greek Pnyx (/nɪks/): a supportive space for open, inclusive, informed, and thoughtful exchanges of ideas, for the practice of the ancient
              art of asking the right questions to move beyond hype and arrive at knowledge.
            </p>
            <h2>DeFi.WTF pierces through the surface of decentralized finance</h2>
    ...
    <footer class="footer-section spad set-bg" data-setbg="src/assets/img/footer-bg.svg">
        <div class="container">
            <div class="social-links">
                ...
                <a href="https://twitter.com/WTFdao" class="twitter wow fadeInDown" data-wow-delay="0.4s"><i class="fa fa-twitter"></i></a>
                <a target="_blank" href="https://github.com/carboclan/pm/issues/69" class="github wow fadeInDown" data-wow-delay="0.4s"><i class="fa fa-github"></i></a>
...
export default {
  name: "APP",
  components: { InfoBoard, Billboard, Header },
  data() {
    return {
      title: "",
      startPrice: "",
